...
- source size inventory:
  ...
  - integrated `tinygrad-rss/src`: 33 RSS files, 25,860 LOC.
...
- validates Tensor `scaled_dot_product_attention` against real tinygrad for the no-mask,
  no-dropout batched case.
