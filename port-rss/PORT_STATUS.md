...
| **capstone: training** | **SGD training loop driven by the ported autodiff** (`train.rss`): linear regression w*x~=y, forward+reverse-mode backward+update | ✅ loss 56->~0; w converges to true slope 2.0 over 50 iters |
