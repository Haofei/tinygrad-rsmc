...
| `tensor.py` (CORE) | **Tensor as a lazy UOp-graph wrapper** (`tensor.rss`): t_const/t_var/t_add/t_mul build UOp nodes; integrates with simplify | ✅ (x*1)+(2+3)->Add(Var7,Const5); (2*3)+4->Const(10) |
