...
| `device.py`/`runtime` | **Device[name] dispatch + CPU-interpreter runtime backend** (`device.rss`): tree-walking UOp evaluator over host Float buffers | ✅ Device[interp] (x+2)*3 over [1,2,3] -> 9 12 15; unknown device handled gracefully |
